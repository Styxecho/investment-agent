...
for i in range(2, len(macro_df)):
    ...
    if pmi_level == 'N/A' or iav_level == 'N/A':
        ...
        growth_direction = pmi_level  # 扩张 or 收缩
    else:
        growth_direction = '中性'
...
# 保存Markdown
md_path = 'D:/Study/Project/investment-agent/docs/research/macro_analysis/macro_state_v4.md'
...
# 保存CSV
csv_path = 'D:/Study/Project/investment-agent/docs/research/macro_analysis/macro_state_v4.csv'
